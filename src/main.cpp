...
int main(int, char**)
{
    ...
    GLFWwindow* window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "RaceRep", NULL, NULL);
    if (window == NULL)
        return 1;
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //ImGui::ShowDemoWindow(NULL);//DEMO WINDOW
...
void LoadSetLogo(GLFWwindow* window)
{
    ...
    unsigned char* pixels = stbi_load("assets\\images\\RaceRep.png", &width, &height, &channels, 4);
    logo[0].pixels = pixels;
    logo[0].width = width;
